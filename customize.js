...
(function() {
  ...
  async function createSurprise() {
    ...
    try {
      ...
      const url = window.location.origin + '/standalone/surprise.html?s=' + data.shareToken;
      return { token: data.shareToken, url: url };
    } catch (err) {
